...
class Scope implements ScopeInterface
{
    ...
    /**
     * @param mixed @storage
     * Either an array of supported scopes, or an instance of Storage\ScopeInterface
     */
    public function __construct($storage = null)
    {
        ...
        if (!$storage instanceof ScopeStorageInterface) {
            throw new \InvalidArgumentException("Argument 1 to Scope must be null, an array, or instance of Storage\ScopeInterface");
        }
